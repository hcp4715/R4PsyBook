...
<div class="figure">
<img src="1012-lesson12_files/figure-html/plot1-1.png" alt="Interaction between identity and valence for (A) sensitivity and (B) reaction times." width="1728" />
<p class="caption">(\#fig:plot1)Interaction between identity and valence for (A) sensitivity and (B) reaction times.</p>
</div>
